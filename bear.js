/*
http-response ^https:\/\/buy\.itunes\.apple\.com\/verifyReceipt$ requires-body=1,max-size=0,script-path=https://github.com/wubulaba/surgescript/raw/master/bear.js,script-update-interval=0
*/
